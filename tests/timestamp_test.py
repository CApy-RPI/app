...
class TestTimestamp(unittest.TestCase):
    ...
    def test_initialization_without_timezone(self):
        ...
        self.assertEqual(self.timestamp.get_datetime(), "12/31/23 11:00 PM EST -0500")
